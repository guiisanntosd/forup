  ...
  return (
    <Container>
      ...
      <div className="wrapper-content fp-fancy-scrollbar">
        ...
        <ul>
          <li><NavLink activeClassName='active' exact to={`${url}/criatividade`}>CRIATIVIDADE</NavLink></li>
          <li><NavLink activeClassName='active' exact to={`${url}/tecnologia`}>TECNOLOGIA</NavLink></li>
        </ul>
        <div>
          <Switch>
            <Route path={`${path}/criatividade`}>
              <TopicContent>
